package org.telegramkr.messenger.sdk.store.component;
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < tabCount; i++) {
            if (pager.getAdapter() instanceof IconTabProvider) {
                addIconDrawableTab(i, ((IconTabProvider) pager.getAdapter()).getPageIconDrawable(i));
            } else {
...
//    }
    ...
    private void addIconDrawableTab(final int position, Drawable drawable) {
        ImageButton tab = new ImageButton(getContext());
        tab.setFocusable(true);
...
//                }
    ...
    public void onSizeChanged(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
        if (!shouldExpand) {
            post(new Runnable() {
                public void run() {
                    PagerSlidingTabStripEx.this.notifyDataSetChanged();
                }
            });
        }
    }
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            try {
                ...
                if(e1.getX() - e2.getX() > SWIPE_MIN_DISTANCE && Math.abs(velocityX) > SWIPE_THRESHOLD_VELOCITY) {
                    ...
                    mActiveFeature = (mActiveFeature < ( tabsContainer.getChildCount() - 1))? mActiveFeature + 1: tabsContainer.getChildCount() -1;
