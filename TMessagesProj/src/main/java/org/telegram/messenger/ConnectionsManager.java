                    ...
                    if (request.respondsToMessageId(resultMid)) {
                        ...
                        if (request.completionBlock != null) {
                            ...
                            if (resultContainer.result instanceof TLRPC.TL_gzip_packed) {
                                ...
                                try {
                                    TLObject uncomressed = Utilities.decompress(packet.packed_data, request.rawRequest, true);
                                    if (uncomressed == null) {
                                        System.gc();
                                        uncomressed = Utilities.decompress(packet.packed_data, request.rawRequest, true);
                                    }
                                    if (uncomressed == null) {
