...
import me.ttalk.sdk.manager.CrashHandler;
...
public class ApplicationLoader extends Application
{
    ...
    public static volatile FragmentActivity fragmentActivity = null;
    ...
    public static EmoticonModel emoticonItemObject = null;
    public static int StickerDrawable = 0;
                ...
                synchronized (sync) {
                    ...
                    try {
                        ...
                        if (selectedColor == 0) {
                            ...
                            Drawable bgDrawable = ThemeManager.getInstance().getRemoteResourceDrawable("background_hd");
                            if (bgDrawable != null) {
                                cachedWallpaper = bgDrawable;
                                isCustomTheme = true;
                            }
                        }
    ...
    public void onCreate() {
        ...
        ServiceAgent.getInstance(ApplicationLoader.applicationContext, BuildVars.DEBUG_VERSION, BuildVars.SESSION_KEY);
        ItemManager.getInstance(ApplicationLoader.applicationContext, BuildVars.EMOTICON_APP_API_KEY);
        ThemeManager.init(ApplicationLoader.applicationContext);
        AndroidUtilities.checkForTheme(ApplicationLoader.applicationContext);
