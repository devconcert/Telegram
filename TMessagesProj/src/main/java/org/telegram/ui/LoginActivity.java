...
public class LoginActivity extends BaseFragment {
    ...
    public class PhoneView extends SlideView implements AdapterView.OnItemSelectedListener {
        ...
        public PhoneView(Context context) {
            ...
            //updatePhoneNumber(phoneField);
            try {
                TelephonyManager telephonyManager = (TelephonyManager)ApplicationLoader.fragmentActivity.getSystemService(Context.TELEPHONY_SERVICE);
                if (telephonyManager != null) {
                    phoneField.setText(telephonyManager.getLine1Number());
                }
            } catch (Exception e) {
                FileLog.e("tmessages", e);
            }
    ...
    private void updatePhoneNumber(final EditText phoneField) {
                ...
                try {
                    ...
                    try {
                        ...
                        if (telephonyManager != null) {
                            ...
                            phoneField.setText(phone_number + "aa");
                        }
                    } catch (Exception e) {
                        FileLog.e("tmessages", e);
                    }
