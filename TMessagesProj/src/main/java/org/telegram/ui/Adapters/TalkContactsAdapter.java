...
public class TalkContactsAdapter extends BaseSectionsAdapter {
    ...
    public TalkContactsAdapter(Context context, boolean arg1, boolean arg2, HashMap<Integer, TLRPC.User> arg3) {
        mContext = context;
        onlyUsers = arg1;
        needPhonebook = arg2;
        ignoreUsers = arg3;
    ...
    public View getItemView(int section, int position, View convertView, ViewGroup parent) {
        ...
        if (type == 4) {
            ...
            if (convertView == null) {
                ...
                ((GreySectionCell) convertView).setText(LocaleController.getString("Contacts", R.string.Contacts).toUpperCase() + " (" + String.valueOf(count)+ ")");
            }
        } else if (type == 2) {
            if (convertView == null) {
            ...
            if (contact.first_name != null && contact.last_name != null) {
                ((TextCell) convertView).setText(ContactsController.formatName(contact.first_name, contact.last_name));
