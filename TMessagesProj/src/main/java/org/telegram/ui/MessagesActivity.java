    ...
    public View createView(final Context context, LayoutInflater inflater) {
        ...
        searchItem.setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() {
            ...
            public void onSearchExpand() {
                ServiceAgent.getInstance().logEvent("Messages.ActionBar", "Search");
                searching = true;
                if (listView != null) {
                    if (searchString != null) {
        ...
        searchItem.getSearchField().setHint(LocaleController.getString("SendMessageTo", R.string.SendMessageTo));
        if (onlySelect) {
        ...
        listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                ServiceAgent.getInstance().logEvent("Messages", "ItemClick");
                long dialog_id = 0;
                int message_id = 0;
                RecyclerView.Adapter adapter = listView.getAdapter();
                if (adapter == dialogsAdapter) {
                    ServiceAgent.getInstance().logEvent("Messages", "DialogsAdapter");
                    ...
                    ServiceAgent.getInstance().logEvent("Messages", "DialogsSearchAdapter");
        ...
        listView.setOnItemLongClickListener(new RecyclerListView.OnItemLongClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                ServiceAgent.getInstance().logEvent("Messages", "ItemLongClick");
                ...
                builder.setItems(new CharSequence[]{LocaleController.getString("ClearHistory", R.string.ClearHistory),
                    ...
                    public void onClick(DialogInterface dialog, final int which) {
                        ...
                        builder.setTitle(LocaleController.getString("AppName", R.string.AppName));
                        if (which == 0) {
                            ServiceAgent.getInstance().logEvent("Messages", "ClearHistory");
                            builder.setMessage(LocaleController.getString("AreYouSureClearHistory", R.string.AreYouSureClearHistory));
                        } else {
                            if (isChat) {
                                ServiceAgent.getInstance().logEvent("Messages", "DeleteGroupExit");
                                builder.setMessage(LocaleController.getString("AreYouSureDeleteAndExit", R.string.AreYouSureDeleteAndExit));
                            } else {
                                ServiceAgent.getInstance().logEvent("Messages", "DeleteThisChat");
                        ...
                        builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                if (which != 0) {
                                    if (isChat) {
                                        ServiceAgent.getInstance().logEvent("Messages", "DeleteUser");
                                    ...
                                    if (AndroidUtilities.isTablet()) {
                                        ServiceAgent.getInstance().logEvent("Messages", "TabletCloseChat");
...
//        }
        ...
        floatingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ServiceAgent.getInstance().logEvent("Messages.FloatingButton", "TalkCreate");
    ...
    private void setRemoteTheme() {
        if (onlySelect) {
            ...
            Drawable drawable = ThemeManager.getInstance().getRemoteResourceDrawable("ic_ab_logo");
            if (drawable != null){
                actionBar.setBackButtonDrawable(drawable);
            }else{
                actionBar.setBackButtonDrawable(new MenuDrawable());
        ...
        Drawable drawable = ThemeManager.getInstance().getRemoteResourceDrawable("background_main");
        if (drawable != null){
        ...
        Drawable floatDrawable = ThemeManager.getInstance().getRemoteResourceDrawable("floating_action_button");
        if (floatDrawable != null) {
            floatingButton.setImageDrawable(floatDrawable);
            Drawable drawableBg = ThemeManager.getInstance().getRemoteResourceDrawable("floating_action_button_bg");
            if (drawableBg != null){
                if (Build.VERSION.SDK_INT >= 16) floatingButton.setBackground(drawableBg);
                else {
                    floatingButton.setBackgroundDrawable(drawableBg);
                }
            }
        }else {
            try {
                floatingButton.setImageResource(R.drawable.floating_message2);
                Drawable floatingDrawableWhite = ApplicationLoader.applicationContext.getResources().getDrawable(R.drawable.floating3_profile);
                int theme_selected = ThemeManager.getInstance().getThemeColor();
                floatingDrawableWhite.setColorFilter(theme_selected, PorterDuff.Mode.MULTIPLY);
                if (Build.VERSION.SDK_INT >= 16) {
                    floatingButton.setBackground(floatingDrawableWhite);
                } else {
                    floatingButton.setBackgroundDrawable(floatingDrawableWhite);
                }
            }catch(Exception e){
//                floatingDrawableWhite.setColorFilter(0xff54759e, PorterDuff.Mode.MULTIPLY);
            }
        }
    }
