...
public class ResourceLoader {
    ...
    public static void loadRecources(Context context) {
        if (backgroundDrawableIn == null) {
            backgroundDrawableIn = ThemeManager.getInstance().getChatCellRemoteResource("msg_in", R.drawable.msg_in);
            backgroundDrawableInSelected = ThemeManager.getInstance().getChatCellRemoteResource("msg_in_selected", R.drawable.msg_in_selected);
            backgroundDrawableOut = ThemeManager.getInstance().getChatCellRemoteResource("msg_out", R.drawable.msg_out);
            backgroundDrawableOutSelected = ThemeManager.getInstance().getChatCellRemoteResource("msg_out_selected", R.drawable.msg_out_selected);
            backgroundMediaDrawableIn = ThemeManager.getInstance().getChatCellRemoteResource("msg_in_photo", R.drawable.msg_in_photo);
            backgroundMediaDrawableInSelected = ThemeManager.getInstance().getChatCellRemoteResource("msg_in_photo_selected", R.drawable.msg_in_photo_selected);
            backgroundMediaDrawableOut = ThemeManager.getInstance().getChatCellRemoteResource("msg_out_photo", R.drawable.msg_out_photo);
            backgroundMediaDrawableOutSelected = ThemeManager.getInstance().getChatCellRemoteResource("msg_out_photo_selected", R.drawable.msg_out_photo_selected);
            checkDrawable = ThemeManager.getInstance().getChatCellRemoteResource("msg_check", R.drawable.msg_check);
            halfCheckDrawable = ThemeManager.getInstance().getChatCellRemoteResource("msg_halfcheck", R.drawable.msg_halfcheck);
            clockDrawable = ThemeManager.getInstance().getChatCellRemoteResource("msg_clock", R.drawable.msg_clock);
            checkMediaDrawable = ThemeManager.getInstance().getChatCellRemoteResource("msg_check_w", R.drawable.msg_check_w);
            halfCheckMediaDrawable = ThemeManager.getInstance().getChatCellRemoteResource("msg_halfcheck_w", R.drawable.msg_halfcheck_w);
            clockMediaDrawable = ThemeManager.getInstance().getChatCellRemoteResource("msg_clock_photo", R.drawable.msg_clock_photo);
            errorDrawable = ThemeManager.getInstance().getChatCellRemoteResource("msg_warning", R.drawable.msg_warning);
            mediaBackgroundDrawable = ThemeManager.getInstance().getChatCellRemoteResource("phototime", R.drawable.phototime);
            broadcastDrawable = ThemeManager.getInstance().getChatCellRemoteResource("broadcast3", R.drawable.broadcast3);
            broadcastMediaDrawable = ThemeManager.getInstance().getChatCellRemoteResource("broadcast4", R.drawable.broadcast4);
            backgroundBlack = ThemeManager.getInstance().getChatCellRemoteResource("system_black", R.drawable.system_black);
            backgroundBlue = ThemeManager.getInstance().getChatCellRemoteResource("system_blue", R.drawable.system_blue);
